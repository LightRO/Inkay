/*  Copyright 2024 Pretendo Network contributors <brocatech.com>
...
const std::pair<const char *, const char *> dns_replacements[] = {
        // NNCS servers
        { "nncs1.app.nintendowifi.net", "nncs1.app.brocatech.com" },
        { "nncs2.app.nintendowifi.net", "nncs2.app.brocatech.com" },
};
